          ...
          <div class="head-left">
            <div style="float: left; padding-right: 10px">
              <router-link style="font-size: 25px; font-weight: bold" to="/">
                  <span style="color: orangered">Love</span>
              <span style="color: #00b5ad">learning</span>
              </router-link>
            </div>
            <!-- <div class="head-nav">
            ...
            <div style="float: left; padding-left: 40px">
              <form method="GET" action="/search" accept-charset="UTF-8" @submit.prevent="search()">
                <input class="search-input" name="q" type="text" v-model="q" placeholder="输入文章关键字">
                <input type="submit" value="搜索" class="form-buttom">
              </form>
            </div>
